package high_traffic_board.view.controller;

import high_traffic_board.view.service.ArticleViewService;
...
public class ArticleViewController {
    ...
    @PostMapping("/v1/articles-views/articles/{articleId}/users/{userId}")
